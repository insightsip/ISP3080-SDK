 ...
 uint32_t dev_id;
  int  err; 
   ...
   // dwt_setlnapamode(DWT_LNA_ENABLE | DWT_PA_ENABLE);
    ...
    dwt_setinterrupt(DWT_INT_SPIRDY_BIT_MASK | DWT_INT_TXFRS_BIT_MASK | DWT_INT_RXFCG_BIT_MASK | DWT_INT_RXFTO_BIT_MASK | DWT_INT_RXPTO_BIT_MASK | DWT_INT_RXPHE_BIT_MASK
